...
export class QueuePredictionService {
    stallData = new Map();
    WINDOW_SIZE_MS = 60000; // 1 minute window for rates
    constructor() {
        eventBus.subscribe('queue.pulse', (e) => this.handlePulse(e));
    }
    async handlePulse(event) {
    ...
    async predict(stallId, correlationId) {
