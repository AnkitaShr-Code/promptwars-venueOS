...
import { CongestionAlert } from '../../shared/types.js';
...
export class NotificationService {
    private pushBreaker: CircuitBreaker;
    private readonly FATIGUE_TTL = 300; // 5 minutes between alerts for same zone/user
    ...
    constructor() {
        ...
        eventBus.subscribe('alert.crowd', (e) => this.handleAlert(e as CongestionAlert));
    }

    private async handleAlert(event: CongestionAlert) {
     ...
     */
    private async mockPushProvider(alert: CongestionAlert): Promise<void> {
